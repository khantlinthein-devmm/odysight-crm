...
<template>
  ...
  <div
    ...
    class="rounded-xl border border-slate-200 bg-white px-6 py-16 text-center"
  >
    <p class="text-sm font-medium text-slate-900">Lead not found</p>
    <a
      href="/leads"
  ...
  <template v-else>
    <nav class="mb-4 flex items-center gap-2 text-sm text-slate-500">
      <a href="/leads" class="hover:text-slate-700">Leads</a>
      <span>/</span>
    ...
    <div class="rounded-xl border border-slate-200 bg-white">
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="flex h-11 w-11 items-center justify-center rounded-full bg-indigo-100 text-base font-semibold text-indigo-700"
          >
